...
Future SO_sale_invoice({context, List<InvoiceItemModel>? ITEMmodel}) => showDialog(
    context: context,
    builder: (context) {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                    child: borderContainer(
                                        text: SalesOrder!.Remaind.toString())),
                              ],
                            ),
                            SizedBox(
                              height: 7,
...
Widget recipts({colors, context, cubit, InvoiceItemModel? ITEMmodel}) =>
    Column(
      children: [
        Container(
          height: 43,
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  ITEMmodel!.ITEM_NAME!.toString(),maxLines: 10,
                  textAlign: TextAlign.center,
                  style: TextStyle(
...
// saveImage(Uint8List byte)async
// {
//   final directory = await getApplicationDocumentsDirectory();
//   final imagePath = await File('${directory.path}/imagee.png');
//   await imagePath.writeAsBytes(byte);
//
// }